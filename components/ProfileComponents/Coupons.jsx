...
const Coupons = () => {
  return (
    <div>
      {offers.map((offer) => (
        <div className="border border-gray-300x mt-5">
          ...
          <div className="flex text-sm text-gray-500 justify-between px-5 py-4">
            ...
            <div className="font-bold text-indigo-400 cursor-pointer">
              Details
            </div>
          </div>
        </div>
